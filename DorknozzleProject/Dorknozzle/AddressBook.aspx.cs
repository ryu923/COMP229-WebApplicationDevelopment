...
namespace Dorknozzle
{
    public partial class AddressBook : System.Web.UI.Page
    {
        ...
        protected void employeeDetails_ItemDeleted(object sender, GridViewSortEventArgs e)
        {
            grid.DataBind();
        }

        protected void employeeDetails_ItemInserted(object sender, GridViewSortEventArgs e)
        {
            grid.DataBind();
        }

        protected void employeeDetails_ItemUpdated(object sender, GridViewSortEventArgs e)
        {
            grid.DataBind();
        }
